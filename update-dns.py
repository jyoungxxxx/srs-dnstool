...
parser.add_argument('hostname', type=str,
                    help='DNS fully-qualified host name with an A record.  If the hostname consists of only a domain \
                    name (i.e., it contains only one period), the record for @ is updated.')
...
parser.add_argument('--force', type=bool, default=False,
                    help='force update of GoDaddy DNS record even if DNS query indicates that record\
                     is already correct.')
